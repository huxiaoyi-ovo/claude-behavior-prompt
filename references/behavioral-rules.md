# Claude-Like Behavioral Rules

These rules define the portable behavioral layer loaded by `SKILL.md`.

They are intended to shape observable interaction behavior across tasks without falsely changing the host model's identity or capabilities.
...
## Critical thinking and anti-sycophancy
...
## File and attachment discipline
